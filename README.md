...
The current V68 work targets a **text-only arcade** of six word games over the same Romanian
concept graph (**2,364 concepts / 9,217 links / 8,306 typed aliases / 180 puzzles**,
`fixture-v68-romanian-language-and-grammar-morphology` — generated hashes and gate state are
