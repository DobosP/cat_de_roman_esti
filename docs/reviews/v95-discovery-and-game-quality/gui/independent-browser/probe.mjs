...
const OUT='/home/dobo/work/_temp/feat__v95-discovery-and-game-quality/gui/independent-browser';
const BASE='http://127.0.0.1:8151', OLD='http://127.0.0.1:8150', API='/api/alchimie/explore', SAVE='cat_alchimie_exploration_v1';
...
try{
 ...
 const report={kind:'v95-independent-empty-pair-browser-v1',reviewer:'codex-v95-independent-world-quality',date:'2026-09-15',candidateOrigin:BASE,baselineOrigin:OLD,passed:true,source_sha256:sourceHashes,served_assets:assetChecks,scenarios:results,script_sha256:sha(OUT+'/probe.mjs')};
