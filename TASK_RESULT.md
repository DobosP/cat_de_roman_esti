...
- Added ADR-0060 and superseded ADR-0053 without editing its landed body.
...
- ADR-0060 intentionally documents the current one-way behavior; future automatic restore
