...
The current V70 work targets a **text-only arcade** of six word games over the same Romanian
concept graph (**2,364 concepts / 9,217 links / 8,352 typed aliases / 180 puzzles**,
`fixture-v70-social-and-civic-life-morphology` — generated hashes and gate state are
