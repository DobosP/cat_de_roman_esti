...
- Status: partially superseded by [ADR-0147](0147-grow-alchimie-with-reviewed-vocabulary.md)
  for inventory, bounds and compatibility history, and by
  [ADR-0155](0155-preserve-discovery-history-and-explain-food-links.md) for the
  historical-book limit; other decisions remain accepted.
- Date: 2026-09-13
