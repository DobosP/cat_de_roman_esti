...
4. Identifică datele în sistem: cont, copia rezultatelor, ID-uri de puzzle terminat,
   recorduri verificate, loguri rezonabil căutabile, consimțământ, corespondență.
...
- repetări și clasament: ID-urile opace ale puzzle-urilor terminate, poreclă, opt-in și
