...
The current V67 work targets a **text-only arcade** of six word games over the same Romanian
concept graph (**2,364 concepts / 9,217 links / 8,258 typed aliases / 180 puzzles**,
`fixture-v67-online-content-and-social-media-morphology` — generated hashes and gate state are
