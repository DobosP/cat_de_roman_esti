...
| Served KG build | `cat_de_roman_esti/fixtures/kg_sample.json` | V88 build; integration/landing state in STATUS. `kg_real.json` is a thin corpus export, **not** the served graph (data.py:27,34-36). |
