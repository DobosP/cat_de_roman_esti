...
BOARDS = (
    ...
    b(
        ...
        g("Români care au jucat în Serie A",
          ...
          "Adrian Mutu", "Cristian Chivu", "Radu Drăgușin", "Dennis Man"),
        ...
        g("Cluburi cu sediul în afara Bucureștiului",
          ...
          "CFR Cluj", "Universitatea Craiova", "FC Barcelona", "Galatasaray"),
    ),
    b(
    ...
    b(
        ...
        g("Se gătesc în ulei sau tigaie",
          "Fiecare se gătește în mod obișnuit prin prăjire.",
          "Langoși", "Cartofi prăjiți", "Cașcaval pane", "Papanași"),
        g("Băuturi alcoolice din fructe",
          "Fiecare este obținută din fructe prin fermentare ori distilare.",
          "Vin", "Țuică", "Pălincă", "Vișinată"),
        g("Fructe potrivite pentru compot",
          "Fiecare este folosit frecvent la compot.",
          "Prună", "Piersică", "Pară", "Strugure"),
    ),
    # -------------------------------------------------------------- geografie / normal
    b(
