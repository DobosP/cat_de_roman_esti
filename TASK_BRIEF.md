...
## Goal
Expose only server-authored safe Cald sau Rece typo suggestions as fill-only actions and preserve accepted autocorrection feedback; keep target secrecy, scoring, the two-hour TTL, the 1,000-session cap, and verify with tests/test_wordgames_contexto.py plus tests/test_wordgames_session_store.py.

## Repo / branch
- Repo: `C:\Users\Paul Work\personal_repos\cat_de_roman_esti`
- Base branch: `main`
- Worker branch: `feat/cald-rece-typo-recovery-v25`
- Worktree: `C:\home\dobo\work\_worktrees\cat_de_roman_esti\cat_de_roman_esti\feat__cald-rece-typo-recovery-v25`
