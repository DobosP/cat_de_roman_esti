...
| Evitare repetări și clasament opțional | utilizatori autentificați cu consimțământ curent; numai utilizatori cu opt-in pentru afișare | ID opac al puzzle-ului selectat editorial și terminat; joc, record verificat, poreclă și preferință de vizibilitate | evitarea repetării puzzle-urilor selectate editorial; publicarea recordului verificat numai cu opt-in | art. 6(1)(b); art. 6(1)(a), după caz | Hetzner; Cloudflare pentru trafic; vizitatorii clasamentului văd doar porecla, jocul și scorul | stocare UE/SEE pe Hetzner `[[CONFIRM: region]]`; răspunsul public nu conține ID puzzle sau identitate Google | durata contului; ștergere odată cu contul `[[CONFIRM]]` | separare de istoricul încărcat, poreclă aleasă explicit, opt-in implicit oprit, consimțământ verificat |
