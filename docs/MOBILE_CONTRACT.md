...
the right generated types. The V66 worktree targets the following build version; generated
hashes and verification state are recorded in `docs/STATUS.md`. This alias-only draft has
8,210 typed aliases and does not change the manifest shape or mobile behavior. The endpoint
