...
# Exact V71 whole-artifact pins after applying the reviewed alias transaction.
...
def test_v71_mobile_contract_and_v49_ledger_persist_exactly() -> None:
    ...
    assert _MOBILE_SHA256 != _V70_MOBILE_SHA256
